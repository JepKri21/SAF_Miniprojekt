...
PT = np.array([[2648, 2479, 5140, 4951, 2057, 4593, 4263, 4559, 1464, 2885, 5325, 2307, 4260, 1618, 1001, 4649],
...
class SubscriberNode(Node):
    def __init__(self):
        super().__init__("subscriber_saf")
        self.chatter_subscriber = self.create_subscription(String, "/chatter", self.msg_callback, 10)
        self.get_logger().info("Subscriber node has been started")


    def msg_callback(self, msg: String):
        parts = msg.data.split(",")
        indexEn = int(parts[0]) #stationID
        indexTo = int(parts[1]) #carrierID
        value = PT[int(indexEn)-1, int(indexTo)-1]
        self.get_logger().info(str(msg) + " stationID: " + str(parts[0]) + " carrierID: " + str(parts[1])+  " Time Value: " + str(value))
